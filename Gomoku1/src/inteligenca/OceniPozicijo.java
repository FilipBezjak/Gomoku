...
public class OceniPozicijo {
	...
	//static char jaz = 'X';
	//char nasprotnik = 'O';
	public static final int ZMAGA = Integer.MAX_VALUE;
	public static final int PORAZ = -ZMAGA;
	public static final int REMI = 0;
	...
	public static int oceniPozicijo(Igra igra, char naPotezi) {
		...
		if (igra.preveriZmago() == naPotezi) {
			return ZMAGA;
		}
		else if (igra.preveriZmago() == nasprotnik(naPotezi)) {
			return PORAZ;
		}
		else if (igra.moznePoteze.size() == 0) {
			return REMI;}
		else {
	...
	public static int test(char[][] polje, char igralec) {
